# /opt/data/private/BlackBox/train11-CDA.py
...
SAVE_DIR = os.path.join(ROOT, "save-cda", "demo")
FINAL_PATCH_DIR = os.path.join(ROOT, "save-cda", "final_patch")
LOG_PATH = os.path.join(ROOT, "save-cda", "train.log")
VISUAL_DIR = os.path.join(ROOT, "save-cda", "visual")
