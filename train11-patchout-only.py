# /opt/data/private/BlackBox/train11-patchout-only.py
...
SAVE_DIR = os.path.join(ROOT, "save-po", "demo")
FINAL_PATCH_DIR = os.path.join(ROOT, "save-po", "final_patch")
LOG_PATH = os.path.join(ROOT, "save-po", "train.log")
VISUAL_DIR = os.path.join(ROOT, "save-po", "visual")
