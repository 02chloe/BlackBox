# /opt/data/private/BlackBox/train.py train_t10.py RATIO=0.3
...
SAVE_DIR = os.path.join(ROOT, "save-0.3", "demo")
FINAL_PATCH_DIR = os.path.join(ROOT, "save-0.3", "final_patch")  # 新增：final patch专用目录
LOG_PATH = os.path.join(ROOT, "save-0.3", "train.log")
VISUAL_DIR = os.path.join(ROOT, "save-0.3", "visual")
