# /opt/data/private/BlackBox/train.py train_t10-pbase0.1.py 
...
SAVE_DIR = os.path.join(ROOT, "save-base0.3", "demo")
FINAL_PATCH_DIR = os.path.join(ROOT, "save-base0.3", "final_patch")  # 新增：final patch专用目录
LOG_PATH = os.path.join(ROOT, "save-base0.3", "train.log")
VISUAL_DIR = os.path.join(ROOT, "save-base0.3", "visual")
...
def main():
    ...
    tmm = TransformerMaskingMatrix(
        num_enc_layers=6, num_dec_layers=6, p_base=0.3,
